...
#include <novae_native_pd/novae_native_pd.h>
#include <base/rpc_client.h>

namespace Genode { struct Novae_native_pd_client; }


struct Genode::Novae_native_pd_client : Rpc_client<Pd_session::Native_pd>
{
	explicit Novae_native_pd_client(Capability<Native_pd> cap)
