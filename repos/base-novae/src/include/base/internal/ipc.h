                                                 ...
                                                 auto const    rcv_cap_count)
{
	...
	for (unsigned i = 0; i < max_caps; i++) {
		...
		utcb.msg()[1] = RPC_CAP_DELEGATION::TAKE; /* protocol */
		utcb.msg()[2] = sel;
...
{
	utcb.msg()[0] = transaction_id;
	utcb.msg()[1] = RPC_CAP_DELEGATION::ID_CANCEL; /* protocol */
...
{
	utcb.msg()[0] = transaction_id;
	utcb.msg()[1] = RPC_CAP_DELEGATION::ID_REGISTER; /* protocol */
	utcb.msg()[2] = pt_dst;
                                           ...
                                           auto const    protocol_value)
{
	...
	for (unsigned i = 0; i < snd_msg.used_caps(); i++) {
		...
		utcb.msg()[0] = transaction_id;
		utcb.msg()[1] = RPC_CAP_DELEGATION::GRANT; /* protocol */
...
{
	utcb.msg()[0] = 0;
	utcb.msg()[1] = RPC_CAP_DELEGATION::GLOBAL_OFFSET; /* protocol */
